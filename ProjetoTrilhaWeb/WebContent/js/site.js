function validaFaleConosco(){
	var nome = document.frmfaleconosco.txtnome.value;// receber o valor do campo txtnome em uma variável
	var expRegNome = new RegExp("^[A-zÀ-ü]{3,}([ ]{1}[A-zÀ-ü]{2,})+$");//Criado um objeto RegExp e atribuido a variável expRegNome
	
if(!expRegNome.test(nome)){
	alert("Preencha o campo Nome corretamente. ");
		document.frmfaleconosco.txtnome.focus();/*motivo de após o "ok" ir direto ao input do Nome, devido ao focus*/
...
if(document.frmfaleconosco.selmotivo.value==""){
	alert("Selecione uma das opções do Motivo do Contato. ");
...
if(document.frmfaleconosco.selmotivo.value=="PR"){
	...
	alert("Selecione um dos produtos para saber informações. ");
